...
public class TestUtil {
    ...
    public static void testLookup(int logicalAddress, PageTable pageTable, MainMemory mainMemory, int expected) {
        testLookup(logicalAddress, pageTable, mainMemory, expected, false);
    }

    public static void testLookup(int logicalAddress, PageTable pageTable, MainMemory mainMemory, int expected, boolean expectedTlbHit) {
        LookupInfo info = new LookupInfo(logicalAddress, pageTable);
